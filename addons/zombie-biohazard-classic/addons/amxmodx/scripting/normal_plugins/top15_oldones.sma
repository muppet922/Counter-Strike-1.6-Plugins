...
*   StatsX Plugin
*
* You can edit this for your own server, just take it...it's a gift.
*  just a hand made version for everyone
*
* This is a 100% working version.
* TEST
*
...
new const g_szCups[ ][ ] = {
    "http://i.imgur.com/oE9wtrz.png",
    "http://i.imgur.com/qdAvpbK.png",
    "http://i.imgur.com/0cHibG1.png"
}; 
...
format_top15(sBuffer[MAX_BUFFER_LENGTH + 1])
{
    ...
    iLen = format(sBuffer, MAX_BUFFER_LENGTH, "<body bgcolor=#000000><div align=center><img src=https://imagizer.imageshack.com/img924/3066/6J9L23.png></div><font color=#FFFFFF><pre>")
