...
public plugin_init()
{
	...
	cvar_cnvg = register_cvar("nvg_custom", "0")
	cvar_nvgsize = register_cvar("bio_nvg_size", "250")
	cvar_nvgcolor[0] = register_cvar("nvg_color_R", "100")
	cvar_nvgcolor[1] = register_cvar("nvg_color_G", "0")
	cvar_nvgcolor[2] = register_cvar("nvg_color_B", "0")
...
public event_infect(victim,attacker)
{
	...
	client_printc(victim, "!g[Biohazard] !nPress !t(N) !nto use NightVision")
