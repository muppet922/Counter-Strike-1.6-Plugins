...
// Configuration Extra Itesm
#define NAME_EXTRA_ITEMS	"M4A1 Dark Knight"
#define TEAM_EXTRA_ITEMS	ZP_TEAM_HUMAN
#define COST_EXTRA_ITEMS	30
...
new V_MODEL[64] = "models/v_buffm4_fix.mdl"
...
{
	"sprites/asep/muzzleflash43.spr",
	"sprites/asep/muzzleflash44.spr",
	"sprites/asep/muzzleflash45.spr"
}
...
new g_Muzzleflash_Ent[3], g_Muzzleflash[33][3], g_Mode[33], Float:TargetOrigin[3], g_item
...
public plugin_init()
{
	...
	cvar_dmg = register_cvar("buffm4_damage", "2.0")
